...
export class IngestionService {
    ...
    async fetchExternalData(city) {
        try {
            ...
            console.log(`[INGESTION] Weather recorded: Precipitation=${precipitationMm.toFixed(2)}mm, AQI=${aqiLevel}, Extreme=${isExtremeThreshold}`);
            ...
            if (Math.random() < 0.5) {
                ...
                console.log(`[INGESTION] News Signal created: StrongMatch=${isStrongMatch}, Keywords=${matchedKeywords.join(', ')}`);
            }

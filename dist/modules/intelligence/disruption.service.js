...
export class DisruptionService {
    ...
    async evaluateCity(city) {
        try {
            ...
            console.log(`[DISRUPTION] Today's Orders: ${todayOrders}, Historical Avg: ${HISTORICAL_AVG_ORDERS}, Drop: ${(activityDropRatio * 100).toFixed(2)}%`);
            // 3. Decision Matrix
            ...
            if (isCrisis) {
                ...
                console.log(`🚨 [CRISIS EVENT] Type: ${event.type} | City: ${city} | Event ID: ${event.id} | Triggering Payouts...`);
